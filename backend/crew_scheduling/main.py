...
class Schedule:
    ...
    def create_data(self):
        ...
        TIMES = [
            ("T" + "{:02d}".format(i), "{:02d}:{:02d}".format(i // 2 + 5, (i % 2) * 30))
            for i in range(38)
        ]
...
class GeneticAlgorithm:
    def __init__(self, final_generation=1000, population_size=50, crossover_rate=0.5, mutation_rate=0.1):
...
if __name__ == "__main__":
    # final_generation=1000, population_size=50, crossover_rate=0.5, mutation_rate=0.1
    # for final_generation in range(20, 100, 20):
    #     for population_size in range(50, 200, 50):
    #         for crossover_rate in [0.5, 0.7, 0.9]:
    #             for mutation_rate in [0.1, 0.01, 0.001]:
    #                 print(f"Running with {final_generation}, {population_size}, {crossover_rate}, {mutation_rate}")
    #                 gen = GeneticAlgorithm(final_generation=final_generation, population_size=population_size, crossover_rate=crossover_rate, mutation_rate=mutation_rate)
    #                 gen.run()
    gen = GeneticAlgorithm(final_generation=1000, population_size=50, crossover_rate=0.8, mutation_rate=0.01)
    res = gen.run()
    res_dict = {}
